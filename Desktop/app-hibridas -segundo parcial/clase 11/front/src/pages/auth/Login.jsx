...
const Login = () => {
  ...
  const onSubmit = (formData) => {
    loginService({
      ...
      .then(data => {
        // En tu backend, "data" es directamente el objeto que tiene el rol e información del usuario
        // Lo mandamos como token y pasamos el email
        ...
        <form onSubmit={handleSubmit(onSubmit)} >
          ...
          <div className='mb-3'>
            ...
            <input 
              ...
              className={`form-control ${pass.length > 0 ? errors.pass ? "is-invalid" : "is-valid" : ""}`} 
              {...register("pass", {
